        ...
        <Grid container spacing={4} alignItems="center">
          ...
          <Grid item xs={12} md={8}>
            <Typography variant="body1" paragraph>
              ...
              clinical psychologist with a passion for helping patients live a
              life based on their own personally-chosen values. She believes
              that life will always be full of stressors that will create
              distress (i.e., anxiety, depression, worry). That is not the
              problem. The issue is what we, as humans tend to do when
              ...
              directions forv values-based living.
            </Typography>
